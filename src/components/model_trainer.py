...
import os
import sys
from src.utils import saving_obj,evaluate_models
...
class ModelTrainer:
    ...
    def initiate_model_training(self,train_arr,test_arr):
        try:
            ...
            models_report:dict = evaluate_models(x_train,x_test,y_train,y_test,models,params)
            ...
            logging.info(f"best model found {best_model} and scaore {best_model_score}")

            saving_obj(self.model_trainer_obj.model_trainer_filepath,best_model)
